      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8">
            <a href="/#home" className="text-gray-700 hover:text-blue-600" aria-label="Go to Home">Home</a>
            <a href="/#destinations" className="text-gray-700 hover:text-blue-600" aria-label="View Destinations">Destinations</a>
            <a href="/#packages" className="text-gray-700 hover:text-blue-600" aria-label="View Packages">Packages</a>
            <a href="/#trekking" className="text-gray-700 hover:text-blue-600" aria-label="View Trekking Packages">Trekking Packages</a>
            <a href="/#resorts" className="text-gray-700 hover:text-blue-600" aria-label="View Resorts">Resorts</a>
            <a href="/#gallery" className="text-gray-700 hover:text-blue-600" aria-label="View Gallery">Gallery</a>
            <a href="/about" className="text-gray-700 hover:text-blue-600" aria-label="Learn About Us">About</a>
            <a href="/contact" className="text-gray-700 hover:text-blue-600" aria-label="Contact Us">Contact</a>
          </div>
